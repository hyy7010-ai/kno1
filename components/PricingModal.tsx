                    ...
                    <>
                      ...
                      <div className="mt-8 border-t border-zinc-700/50 pt-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <button 
                            onClick={() => handleBuyOnline('https://your-lemonsqueezy-store.com/checkout/buy/1-month')}
                            ...
                            <div className="text-2xl font-black mb-1">$9.9</div>
                            <div className="text-[10px] text-zinc-400 flex items-center gap-1">Opens in browser <Shield className="w-3 h-3" /></div>
                            </button>

                            <button 
                            onClick={() => handleBuyOnline('https://your-lemonsqueezy-store.com/checkout/buy/6-months')}
                            ...
                            <div className="text-2xl font-black mb-1">$29</div>
